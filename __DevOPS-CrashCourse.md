...
route add 10.0.0.0/8 via 10.71.1.4
route add 200.0.0.0/24 via 10.71.1.4
~~~
...
~~~
[realdevices]
ctaas ansible_host=10.71.1.2 ansible_user=admin ansible_password=pass
cbaba ansible_host=10.71.1.4 ansible_user=rivan ansible_password=C1sc0123
...
~~~
[real_cisco]
CTAAS ansible_host=10.71.1.2
CBABA ansible_host=10.71.1.4
CUCM ansible_host=10.71.100.8
EDGE ansible_host=10.71.71.1
